 ...
 WHERE EMCENTER.CODE    IN  ( SELECT CODE FROM TIGER..LG_024_EMCENTER WHERE  (DEFINITION_ like '%____L_K%'  or DEFINITION_ like '%YEMEK G_DERLER_%'   or DEFINITION_ like '%YOL G_DERLER_%') AND SUBSTRING(CODE,1,3)   ='URT')   AND INV.TRCODE <> 25   