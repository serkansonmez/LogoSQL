...
/****** Object:  View [dbo].[VW_PerformansSonucSeviye2]    Script Date: 16.09.2020 08:03:18 ******/
SET ANSI_NULLS ON
GO
...
--select * from [VW_PerformansSonucSeviye2]

ALTER view [dbo].[VW_PerformansSonucSeviye2] as 
select 
...
--0  as MarkalarTahsilatPuan,
 ...
 + 
 ((isnull(TblMarkalarIletisim.Seviye2,0)  +   isnull(TblMarkalarStok.Seviye2,0) + isnull(TblMarkalarTahsilat.Seviye2,0)) / 3 ) / 2)
 as GenelSonuc
...
--,isnull(TblSube.PuanDegeri,0) as SubePuan
,0 as SubePuan
from     vw_UcretPersonel 
 CROSS JOIN  PerformansDonemleri with(nolock)
  CROSS JOIN  Firmalar with(nolock)
