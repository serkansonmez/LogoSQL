...
/****** Object:  View [dbo].[VW_PerformansHareketlerSeviye1]    Script Date: 3.09.2020 08:48:06 ******/
SET ANSI_NULLS ON
GO
...
GO
 ...
 CREATE View [dbo].[VW_PerformansHareketlerSeviye1] as
 select VW_PerformansHareketler.* from VW_PerformansHareketler 
LEFT join VW_PerformansHareketlerSeviye1Listesi altSeviye on altSeviye.FirmalarId = VW_PerformansHareketler.FirmalarId and 
...
LEFT join VW_PerformansHareketlerSeviye1Listesi ustSeviye on ustSeviye.FirmalarId = VW_PerformansHareketler.FirmalarId and 
