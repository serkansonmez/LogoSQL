...
/****** Object:  View [dbo].[VW_PerformansHareketlerSeviye2Listesi]    Script Date: 3.09.2020 08:48:47 ******/
SET ANSI_NULLS ON
GO
...
create view [dbo].[VW_PerformansHareketlerSeviye2Listesi] as
/*
...
FROM VW_PerformansHareketler
 ...
 SELECT 'Seviye2' as Seviye, HedefBaslik,AdiSoyadi,UcretPersonelId,FirmalarId,PerformansDonemiId,OrganizasyonSemasiId,PerformansAnaHedefleriId,UnvanlarId, avg(PuanDegeri * 1.00) Ortalama , min(PuanDegeri * 1.00) as EnAlt, Max(PuanDegeri * 1.00) as EnUst
...
FROM VW_PerformansHareketlerSeviye1
 -- where AdiSoyadi like 'volkan%'  
 group by HedefBaslik,AdiSoyadi,UcretPersonelId,PerformansDonemiId,FirmalarId,PerformansDonemiId,OrganizasyonSemasiId,PerformansAnaHedefleriId,UnvanlarId
 having   avg(PuanDegeri * 1.00)  > 0
