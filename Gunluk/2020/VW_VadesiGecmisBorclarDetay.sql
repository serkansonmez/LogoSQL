...
/****** Object:  View [dbo].[VW_VadesiGecmisBorclarDetay]    Script Date: 9.11.2020 22:50:37 ******/
SET ANSI_NULLS ON
GO
...
GO
 ...
 ALTER view [dbo].[VW_VadesiGecmisBorclarDetay] as
select 
...
FROM         TIGER3.dbo.LG_003_01_PAYTRANS PT WITH(NOLOCK) INNER JOIN
 ...
 --AND    (CL.code = '120.01.02.08226') 
 AND (PT.DATE_ < CONVERT(DATETIME, GETDATE(), 102))

 --select * from lg_003_clcard  where LOGICALREF= 10396
GO
