...
SELECT    [BÖLÜM]
      ...
      ,[OPERATÖR SÝCÝL NO4]
      ,[OPERATÖR SÝCÝL NO5]
      ,[TOPLAM OPERATÖR SAYISI]
      ,[BAÞLAMA SAATÝ]
      ,[BÝTÝÞ SAATÝ]
      ,[GERÇEKLEÞEN ÝÞ SÜRESÝ ( SAAT)]
      ,[GERÇEKLEÞEN ÝÞ SÜRESÝ (DK)]
      ,[PLANLANAN SÜRE (DK)]
      ,[M1]
      ,[M2]
      ,[M3]
      ...
      ,[FÝRMA ADI]
      ,[KESÝLECEK MAKÝNE]
      ,[DELÝKLÝ CAM /DELÝKSÝZ CAM]
      ,[SÝPARÝÞ ADETÝ]
      ,[PLANLANAN ADET]
      ,[ÜRETÝM ADETÝ]
      ,[SERÝGRAFTA SÝLÝNEN CAM ADETÝ]
      ,[H7]
      ,[H8]
      ,[H9]
      ,[H10]
      ...
      ,[TOPLAM HATA MÝKTARI]
      ,[KALÝTE ONAY SÝCÝL NO]
      ,[PLAKA ADETÝ]
      ,[TOPLAM  PLAKA ADETÝ]
      ,[OTOKLAV HATA AYRIMI]
      ,[KALÝTE BÝTÝÞ MÝKTARI]
      ,[EN]
      ,[BOY]
      ,[KALINLIK]
      ,[RENK]
      ,[ÜRETÝM ALAN  (m²)]
      ,[HATALI ALAN (m²)]
      ,[HATALI ÜRETÝM  YÜZDESÝ (m²)]
      ,[HATALI ÜRETÝM YÜZDESÝ (ADET)]
FROM [dbo].[Uretim2025OcakExcel]    WHERE   [BÖLÜM] NOT LIKE 'KES_M'
...
FETCH NEXT FROM UretimCursor INTO 
    ...
    @H40, @H41, @H42, @H43, @H45, @H47, @H50, @H51,   @ToplamHataMiktari,
	  ...
	  begin
		  ...
		  --  --    STUFF(CAST(CAST(@IsEmriNo AS DECIMAL(20,0)) AS VARCHAR(20)), 5, 0, '.') , 
		   ...
		   begin
			  ...
			  begin
			  -- select * into OperasyonHareket_20250130 from OperasyonHareket
		   insert into OperasyonHareket
			  ...
			  -- select * into HurdaCamHareket_20250130 from HurdaCamHareket
